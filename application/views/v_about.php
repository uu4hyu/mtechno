...
<html class="no-js"> <!--<![endif]-->
	...
	<meta name="author" content="ALMADANI" />
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Who We Are</h2>
		   					<p class="fh5co-lead"> Awesome source code by <a href="https://www.almadani.online/" target="_blank">ALMADANI</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>ALMADANI adalah seorang senior engineer lulusan perguruan tinggi di daerah Banda Aceh.</p>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>Rusmansyah adalah seorang web designer lulusan perguruan tinggi di daerah Banda Aceh.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<h3>Muhammad Tanzil Ulma</h3>
						<h4>Co-Founder, Designer</h4>
						<p>Muhammad Tanzil Ulma adalah seorang web designer lulusan perguruan tinggi di daerah Banda Aceh.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
