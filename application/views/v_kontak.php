			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>198 Aceh 21th Street, Suite 721 Aceh Selatan 10016</li>
						<li><i class="icon-phone"></i>081263423585</li>
						<li><i class="icon-envelope"></i><a href="#">almadani.online</a></li>
						<li><i class="icon-globe"></i><a href="#">almadani.online</a></li>
					</ul>
				</div>
